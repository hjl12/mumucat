...
<body class="easyui-layout">
	...
	<div class="zk-header"
		...
		<div class="zk-header-right">
			<p>
				<strong class="easyui-tooltip" title="无消息">您好</strong>,欢迎您
			</p>
			<p>
	...
	<script type="text/javascript">
				...
				.tree(
						{
							...
							formatter : function(node) {
								if (node.url) {
									return "<a id='menu-"+node.id+"' class='easyui-tree zk-side-tree' data-link="+node.url+">"
											+ node.text + "</a>";
								}
								return node.text;
							}
		...
		window.onload = function() {
			$('a.easyui-tree').bind("click", function() {
				var title = $(this).text();
